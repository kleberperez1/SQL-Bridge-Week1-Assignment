...
-- Kleber Perez - December 23, 2018
-- -----------------------------------

-- 1. Which destination in the flights database is the furthest distance away, based on 
--    information in the flights table.  Show the SQL query(s) that support your conclusion. 
